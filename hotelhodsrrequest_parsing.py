...
if __name__ == "__main__":
  ...
  shopperdaycounttxt = sc.textFile("/user/sg952655/shopperdaycount001/*")
  ...
  Orderedfilteredduplicaterecordcounttxt = sc.textFile("/user/sg952655/Orderedfilteredduplicaterecordcount001/*")
  ...
  rqtparsingtxt = sc.textFile("/user/sg952655/rqtparsing001/*")
